...
{
    public class PagedStackPanel2 : Panel
    {
        ...
        public static readonly DependencyProperty ForegroundProperty = DependencyProperty.Register("Foreground", typeof(Brush), typeof(PagedStackPanel2), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(0x99, 0xAA, 0x00, 0x00))));
        public static readonly DependencyProperty OrientationProperty = DependencyProperty.Register("Orientation", typeof(Orientation), typeof(PagedStackPanel2), new PropertyMetadata(Orientation.Horizontal));
                ...
                if (!(child is ToggleButton))
                {
                    if (k >= ViewFrom && !isFull)
                    {
                        ...
                        if (this.Orientation == Orientation.Horizontal)
                        {
                            ...
                            isFull = (!isLast && (needSize.Width + child.DesiredSize.Width + NAVIGATOR_SIZE > availableSize.Width));
                        ...
                        else
                        {
                            ...
                            isFull = (!isLast && (needSize.Height + child.DesiredSize.Height + NAVIGATOR_SIZE > availableSize.Height));
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            if (Orientation == Orientation.Horizontal)
            {
                ...
                if (PageNextButton != null && PageBackButton != null)
                {
                    if (!IsAllShow && ViewFrom > 0)
                    {
                        PageBackButton.Arrange(new Rect(offset, (finalSize.Height / 2.0 - NAVIGATOR_SIZE), NAVIGATOR_SIZE, NAVIGATOR_SIZE));
                    }
                    else
                    {
                    ...
                    {
                        PageNextButton.Arrange(new Rect(offset, (finalSize.Height / 2.0), NAVIGATOR_SIZE, NAVIGATOR_SIZE));
                    }
                    else
                    {
            ...
            else
            {
                ...
                if (PageNextButton != null && PageBackButton != null)
                {
                    if (!IsAllShow && ViewFrom > 0)
                    {
                        PageBackButton.Arrange(new Rect((finalSize.Width / 2.0 - NAVIGATOR_SIZE), offset, NAVIGATOR_SIZE, NAVIGATOR_SIZE));
                    }
                    else
                    {
                        PageBackButton.Arrange(new Rect(0, 0, 0, 0));
                    ...
                    if (!IsAllShow && !IsLastShow)
                    {
                        PageNextButton.Arrange(new Rect((finalSize.Width / 2.0), offset, NAVIGATOR_SIZE, NAVIGATOR_SIZE));
                    }
                    else
                    {
                        PageNextButton.Arrange(new Rect(0, 0, 0, 0));
